...
class QSANN_text_classifier(nn.Module):
    def __init__(self, S, n, Denc, D, num_layers):
        ...
        self.d= n * (Denc + 2)  # Dimension of input/output vectors
        # self.layer_norm_1 = nn.LayerNorm(self.d,elementwise_affine=False)  # Layer norm input
        # self.layer_norm_2 = nn.LayerNorm(self.d,elementwise_affine=False)  # Layer norm before final linear
