...
class QSANN_text_classifier(nn.Module):
    def __init__(self, S, n, Denc, D, num_layers):
        ...
        # Initialize learned positional encoding as a trainable parameter
        pos_encoding = torch.randn(1, S, self.d) * 0.01  # Small random initialization
